...
public class SettingsActivity extends FragmentActivity
    ...
    private static final String OPEN_SOURCE_LICENSE_KEY = "open_source_license";

    public static final String FIXED_LANDSCAPE_MODE = "pref_fixed_landscape_mode";

    private static final String NOTIFICATION_DOTS_PREFERENCE_KEY = "pref_icon_badging";

    public static final String PREF_HOME_GRID_PORTRAIT_COLUMNS =
            "pref_home_grid_portrait_columns";
    public static final String PREF_HOME_GRID_PORTRAIT_ROWS = "pref_home_grid_portrait_rows";
    public static final String PREF_HOME_GRID_LANDSCAPE_COLUMNS =
            "pref_home_grid_landscape_columns";
    public static final String PREF_HOME_GRID_LANDSCAPE_ROWS = "pref_home_grid_landscape_rows";
    public static final String PREF_HOME_ICON_SIZE_PERCENT = "pref_home_icon_size_percent";
    ...
    public static class LauncherSettingsFragment extends PreferenceFragmentCompat implements
        ...
        protected boolean initPreference(Preference preference) {
            ...
            // PreferenceCategory entries are structural and normally have no key. The original
            // settings screen only contained keyed leaf preferences, but Home customization adds
            // categories; never switch on a null key.
            final String preferenceKey = preference.getKey();
            if (preferenceKey == null) {
                return true;
            }
            if (OPEN_SOURCE_LICENSE_KEY.equals(preference.getKey())) {
                preference.setOnPreferenceClickListener(pref -> {
                    startActivity(new Intent(requireContext(), OpenSourceLicenseActivity.class));
                    return true;
                });
                return true;
            }
            switch (preferenceKey) {
                ...
                case PREF_HOME_GRID_PORTRAIT_COLUMNS:
                case PREF_HOME_GRID_PORTRAIT_ROWS:
                case PREF_HOME_GRID_LANDSCAPE_COLUMNS:
                case PREF_HOME_GRID_LANDSCAPE_ROWS:
                case PREF_HOME_ICON_SIZE_PERCENT:
                    // SeekBarPreference persists the new integer first. Refresh the invariant
                    // profile after the callback so the workspace model migrates to the new grid.
                    preference.setOnPreferenceChangeListener((pref, newValue) -> {
                        View list = getListView();
                        list.post(() -> InvariantDeviceProfile.INSTANCE
                                .get(requireContext().getApplicationContext())
                                .onConfigChanged(requireContext().getApplicationContext()));
                        return true;
                    });
                    return true;
            }
