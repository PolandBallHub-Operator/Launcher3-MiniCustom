...
public class Launcher extends StatefulActivity<LauncherState>
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        // Home grid settings can use different row and column counts in portrait and landscape.
        // Rebuild the invariant profile before this activity reapplies its DeviceProfile so the
        // normal model migration and rebinding path receives the correct target grid.
        InvariantDeviceProfile idp = InvariantDeviceProfile.INSTANCE.get(this);
        if (idp.hasHomeGridOverrides()) {
            idp.onConfigChanged(this);
        }
