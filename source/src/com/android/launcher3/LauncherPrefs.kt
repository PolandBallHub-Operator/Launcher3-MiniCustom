...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        /** Home-grid overrides. A value is stored only after the associated slider is changed. */
        @JvmField val HOME_GRID_PORTRAIT_COLUMNS = backedUpItem(
            SettingsActivity.PREF_HOME_GRID_PORTRAIT_COLUMNS, 0
        )
        @JvmField val HOME_GRID_PORTRAIT_ROWS = backedUpItem(
            SettingsActivity.PREF_HOME_GRID_PORTRAIT_ROWS, 0
        )
        @JvmField val HOME_GRID_LANDSCAPE_COLUMNS = backedUpItem(
            SettingsActivity.PREF_HOME_GRID_LANDSCAPE_COLUMNS, 0
        )
        @JvmField val HOME_GRID_LANDSCAPE_ROWS = backedUpItem(
            SettingsActivity.PREF_HOME_GRID_LANDSCAPE_ROWS, 0
        )
        @JvmField val HOME_ICON_SIZE_PERCENT = backedUpItem(
            SettingsActivity.PREF_HOME_ICON_SIZE_PERCENT, 100
        )
